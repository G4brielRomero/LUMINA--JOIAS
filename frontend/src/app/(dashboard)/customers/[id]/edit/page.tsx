...
import { getCustomer, updateCustomer, CreateCustomerData } from '@/services/customers';
  ...
  useEffect(() => {
    async function load() {
      ...
      try {
        ...
        setForm({
          name: customer.name,
          cpf: formatCPFInput(customer.cpf),
          email: customer.email,
          phone: customer.phone || '',
          address: customer.address || '',
        });
      } catch {
        setLoadError('Erro ao carregar dados do cliente.');
      } finally {
        setLoading(false);
      }
    }
    ...
    <div className="max-w-2xl mx-auto space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-sm text-slate-500 mt-1">Atualize os dados do cliente</p>
        </div>
      </div>
